...
A personal [bootc](https://github.com/bootc-dev/bootc) image based on [Bazzite](https://github.com/ublue-os/bazzite) (KDE Plasma spin), customized with development tooling on top of the stock gaming/desktop image.
